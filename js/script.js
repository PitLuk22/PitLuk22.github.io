document.addEventListener('DOMContentLoaded', function () {
    ...
    reset.src = 'img/icons8-reset.svg';
    field.append(reset);
    ...
    buttons.addEventListener('touchstart', function (event) {
        ...
        if (target && target.tagName == 'BUTTON') {
            if (steps == true) {
                if (target.classList.contains('up') && direction != 'down') {
                    direction = 'up';
                    steps = false;
                } else if (target.classList.contains('down') && direction != 'up') {
                    direction = 'down';
                    steps = false;
                } else if (target.classList.contains('left') && direction != 'right') {
                    direction = 'left';
                    steps = false;
                } else if (target.classList.contains('right') && direction != 'left') {
                    direction = 'right';
                    steps = false;
                }
            }
